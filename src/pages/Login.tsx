          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-xl px-4 py-3 focus:outline-none focus:ring-2 transition ${error
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm text-gray-600">
                <input type="checkbox" className="h-4 w-4 accent-orange-600 rounded" />
                Remember me
              </label>
              <Link
                to="/forgot-password"
